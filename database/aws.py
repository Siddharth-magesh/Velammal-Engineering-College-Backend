...
file_path = r"/root/Velammal-Engineering-College-Backend/docs/CSV/VEC_Faculty_Details.csv"
...
def insert_dept_activities_details():
    ...
    directory = "/root/Velammal-Engineering-College-Backend/docs/DEPT_ACT/"
...
def insert_newsletter():
    ...
    with open ("/root/Velammal-Engineering-College-Backend/docs/news_letter.json","r",encoding="utf-8") as file:
        documents= json.load(file)
        collection.insert_many(documents)
...
def insert_overall_patent():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/overall_patent.json","r",encoding="utf-8") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
#     collection = db['overall_research']
#     with open("/root/Velammal-Engineering-College-Backend/docs/acadamic_research.json","r",encoding="utf-8") as file:
#         documents = json.load(file)
#         collection.insert_one(documents)
...
def insert_programmes_list():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/programmes_list.json", "r",encoding="utf-8") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_departments_list():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/departments_list.json", "r",encoding="utf-8") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_admission_team():    
    ...
    with open('/root/Velammal-Engineering-College-Backend/docs/admission_team.json', "r",encoding="utf-8") as file:
     documents = json.load(file)
     collection.insert_many(documents)
...
def insert_ecell_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/e_cell.json", "r",encoding="utf-8") as file:
        documents = json.load(file)
        collection.insert_many(documents)
