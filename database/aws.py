...
def insert_hod_datas():
    collection = db['HODS']
    with open("/root/Velammal-Engineering-College-Backend/docs/hods.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_infrastructure_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/infrastructure.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_support_staff_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/support_staffs.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_curriculum_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/curriculum.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_events_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/events.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_special_announcements():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/special_announcements.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_announcements_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/announcements.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def principal_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/principal_data.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_admin_office_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/admin_office.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_committee_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/committee.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_regulation_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/regulation.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def placement_team():
    ...
    with open('/root/Velammal-Engineering-College-Backend/docs/placement_members.json', 'r') as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_intake_data():    
    ...
    with open('/root/Velammal-Engineering-College-Backend/docs/intakes.json', "r") as file:
        documents = json.load(file)
    collection.insert_many(documents)
...
def insert_dean_and_associates_data():    
    ...
    with open('/root/Velammal-Engineering-College-Backend/docs/dean_and_associates.json', "r") as file:
        documents = json.load(file)
    collection.insert_many(documents)
...
def insert_placement_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/placements_data.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_curriculum_and_syllabus_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/curriculum_and_syllabus.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_banners():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/banner.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_all_forms_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/all_forms.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_NBA_data():
    collection = db['nba']
    with open("/root/Velammal-Engineering-College-Backend/docs/nba.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_naac_data():
    collection = db['naac']
    with open("/root/Velammal-Engineering-College-Backend/docs/naac.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_nirf_data():
    collection = db['nirf']
    with open("/root/Velammal-Engineering-College-Backend/docs/nirf.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_sidebar_details():
    ...
    with open ("/root/Velammal-Engineering-College-Backend/docs/sidebar.json","r") as file:
        documents= json.load(file)
        collection.insert_many(documents)
...
def insert_army_data():
    collection = db['army']
    with open("/root/Velammal-Engineering-College-Backend/docs/ncc_army.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_navy_data():
    collection = db['navy']
    with open("/root/Velammal-Engineering-College-Backend/docs/navy.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_faculty_data(folder_path):
    department_name=None
    with open(r"/root/Velammal-Engineering-College-Backend/docs/prev_faculty.json","r") as file:
        data=json.load(file)
    try:
...
def insert_sports_Zonal_results():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/sports_zonal.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_sports_Zonal_images():
    collection = db["sports_data"]
    with open("/root/Velammal-Engineering-College-Backend/docs/zonal_images.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_sports_faculty_data():
    collection = db["sports_data"]
    with open("/root/Velammal-Engineering-College-Backend/docs/sports_faculty.json", "r") as file:
        documents = json.load(file)
        collection.insert_one(documents)
...
def insert_sports_achievements_data():
    collection = db["sports_data"]
    with open("/root/Velammal-Engineering-College-Backend/docs/sports_achievements.json", "r") as file:
        documents = json.load(file)
        collection.insert_one(documents)
...
def insert_sports_coordinates():
    collection = db["sports_data"]
    with open("/root/Velammal-Engineering-College-Backend/docs/sports_coordinates.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_other_facilties():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/other_facilties.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_library_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/library.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_nss_personnel():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/nss_personnel.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_nss_carousal():
    collection = db["nss_data"]
    with open("/root/Velammal-Engineering-College-Backend/docs/nss_carousal.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_yrc_data():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/yrc_carousal.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)

    print("yrc_carousal data inserted successfully.")

    with open("/root/Velammal-Engineering-College-Backend/docs/yrc_personnel.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_overall_department_research():
    ...
    with open("/root/Velammal-Engineering-College-Backend/docs/research_data.json","r") as file:
        documents = json.load(file)
        collection.insert_one(documents)
