...
file_path = r"/home/server/Desktop/Velammal-Engineering-College-Backend/docs/VEC Faculty Details.csv"
photo_base_dir = r"/home/server/Desktop/Velammal-Engineering-College-Backend/static/temp_photos/"
base_save_dir = r"/home/server/Desktop/Velammal-Engineering-College-Backend/static/staff_scholar_details/"
...
target_base_dir = r"/home/server/Desktop/Velammal-Engineering-College-Backend/static/images/profile_photos/"
...
def insert_department_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/department_data.json", "r") as file:
...
def insert_hod_datas():
    collection = db['HODS']
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/hods.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_infrastructure_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/infrastructure.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_student_activities_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/student_activities.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_support_staff_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/support_staffs.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_MOUs_data():
    collection = db['MOUs']
    folder_path = "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/MOUs/"
...
def insert_curriculum_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/curriculum.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_events_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/events.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_special_announcements():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/special_announcements.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_announcements_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/announcements.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def principal_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/principal_data.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_admin_office_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/admin_office.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_committee_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/committee.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_regulation_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/regulation.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_intake_data():    
    ...
    with open('/home/server/Desktop/Velammal-Engineering-College-Backend/docs/intakes.json', "r") as file:
        documents = json.load(file)
    collection.insert_many(documents)
...
def insert_dean_and_associates_data():    
    ...
    with open('/home/server/Desktop/Velammal-Engineering-College-Backend/docs/dean_and_associates.json', "r") as file:
        documents = json.load(file)
    collection.insert_many(documents)
...
def insert_placement_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/placements_data.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_curriculum_and_syllabus_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/curriculum_and_syllabus.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_banners():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/banner.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_all_forms_data():
    ...
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/all_forms.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_NBA_data():
    collection = db['nba']
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/nba.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_naac_data():
    collection = db['naac']
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/naac.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_nirf_data():
    collection = db['nirf']
    with open("/home/server/Desktop/Velammal-Engineering-College-Backend/docs/nirf.json", "r") as file:
        documents = json.load(file)
        collection.insert_many(documents)
...
def insert_alumni_data(directory_path='/home/server/Desktop/Velammal-Engineering-College-Backend/docs/ALUMINI'):
...
department_paths = {
    ...
    "002": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/CSE-DEPT-ACT/",
    "003": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/ECE-DEPT-ACT/",
    "004": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/EEE-DEPT-ACT/",
    "005": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/MECH-DEPT-ACT/",
    "006": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/CIVIL-DEPT-ACT/",
    "007": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/IT-DEPT-ACT/",
    "008": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/BME-DEPT-ACT/",
    "009": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/EIE-DEPT-ACT/",
    "010": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/MBA-DEPT-ACT/",
    "011": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/MCA-DEPT-ACT/",
    "012": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/AUTO-DEPT-ACT/",
    "013": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/MTECH-IT-DEPT-ACT/",
    "014": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/ARCH-DEPT-ACT/",
    "015": "/home/server/Desktop/Velammal-Engineering-College-Backend/docs/SCI-HUM-DEPT-ACT/",
}
...
folder_path = r'/home/server/Desktop/Velammal-Engineering-College-Backend/docs/RESEARCH-DATA'
